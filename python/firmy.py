...
try:
    ...
    retVal += "Nie jesteś zalogowany! Wybierz użytkownika:<br /><br /><select name=\"test\" form=\"firmy\" style='width:80%; border-radius: 5px; border: 1px solid black; background-color:rgba(250,250,250,.2); padding: 5px;'>\n"
    ...
    retVal += "</select>"
    retVal += "<form action=\"firmy\" id=\"firmy\" method=\"post\">" \
